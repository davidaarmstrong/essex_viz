...
.myButton:active {
  ...
  window.addEventListener("load", function() {
    ...
    let compmod = document.getElementById("compmod"); 
    checkbox.addEventListener("change", function() {
      if(this.checked) {
        compmod.style.display="inline";
      } else {
        compmod.style.display="none";
      }
    });
  });
')),
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      radioButtons("varby", "Vary Effect by ...", 
                   c("None"="none", "Year" = "year", "Region" = "region", "Incumbent Co-partisan" = "incumbent"), 
                   selected="none"),
      div(id="subset", 
