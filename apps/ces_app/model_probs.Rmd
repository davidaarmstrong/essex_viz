...
The output you are seeing above gives the predicted probability of voting for the selected party (or voting at all in a turnout model) for a change in the "Independent Variable of Interest".  This is one way of understanding the "effect" of a variable.  
